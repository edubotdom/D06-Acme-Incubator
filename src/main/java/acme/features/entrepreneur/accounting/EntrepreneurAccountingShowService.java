...
@Service
public class EntrepreneurAccountingShowService implements AbstractShowService<Entrepreneur, Accounting> {

	// Internal state ---------------------------------------------------------

	@Autowired
	private EntrepreneurAccountingRepository repository;
