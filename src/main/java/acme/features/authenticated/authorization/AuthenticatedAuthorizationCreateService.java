/*
 * AuthenticatedAuthorizedCreateService.java
 *
...
@Service
public class AuthenticatedAuthorizationCreateService implements AbstractCreateService<Authenticated, Authorization> {
	...
	// AbstractCreateService<Authenticated, Authorized> ---------------------------
	...
	public boolean authorise(final Request<Authorization> request) {
		...
		result = this.repository.findOneAuthorizationByUserAccountId(userAccountId);
	...
	@Override
	public Authorization instantiate(final Request<Authorization> request) {
		assert request != null;
	...
	@Override
	public void create(final Request<Authorization> request, final Authorization entity) {
		assert request != null;
		assert entity != null;
