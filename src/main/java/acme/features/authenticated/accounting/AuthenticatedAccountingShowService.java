...
@Service
public class AuthenticatedAccountingShowService implements AbstractShowService<Authenticated, Accounting> {

	// Internal state ---------------------------------------------------------

	@Autowired
	private AuthenticatedAccountingRepository repository;
